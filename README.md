# Audiobookshelf Manager Bot

这是一个基于 Telegram Bot 的 Audiobookshelf 管理工具。

## 功能特点

- 通过 Telegram Bot 控制 Audiobookshelf 服务器
